  ...
  const programWeeks = [
    { 
      ...
      learnings: [
        ...
        "Introduction to n8n interface",
        "Testing your flow so it just works"
      ]
    },
    { 
      week: 2, 
      ...
      learnings: [
        "Saving and organizing your automations in the cloud",
        "Sharing and restoring your work with a few clicks",
        "Peace of mind with version history"
      ]
    },
    { 
      week: 3, 
      ...
      learnings: [
        "Pulling in data from other services automatically",
        "Turning raw info into neat summaries",
        "No-code ways to connect different apps"
      ]
    },
    { 
      week: 4, 
      ...
      learnings: [
        "Converting text news into audio files",
        "Making your creation available to listeners",
        "Stitching together steps to make a mini-app"
      ]
    },
    { 
      week: 5, 
      ...
      learnings: [
        "Enrich nurture emails with personalized Perplexity searches",
        "Use n8n's MCP tools",
        "Keeping your messages fresh and relevant"
      ]
    },
    { 
      week: 6, 
      ...
      learnings: [
        "Using Cursor with MCPs to automate everyday tasks",
        "Building the same MCP powered agent in n8n",
        "Coordinate AI tools in a smooth workflow"
      ]
    },
    { 
      week: 7, 
      ...
      learnings: [
        "Setting up an AI helper to sort and summarize mail",
        "Hands-off triage: let your agent decide what's important",
        "Routing messages where they belong"
      ]
    },
    { 
      week: 8, 
      ...
      learnings: [
        "Mapping out step-by-step processes for your AI helper",
        "Passing context naturally between steps",
    ...
    { 
      ...
      learnings: [
        "Quickly storing and viewing your leads online",
        "Capturing new contacts automatically",
    ...
    { 
      ...
      learnings: [
        "Putting your assistant online so anyone can reach it",
        "Adding voice input/output to your n8n agents",
        "Sharing your service with a public link"
      ]
    },
    { 
      week: 11, 
      ...
      learnings: [
        "Bringing all your tools together smoothly",
        "Having multiple AI helpers work in harmony",
        "Handing off tasks to AI first, human second"
      ]
    },
    { 
      week: 12, 
      ...
      learnings: [
        ...
        "Auto-drafting professional proposals in seconds",
        "Delivering value (and invoices) on autopilot"
      ]
    }
  ];
