            ...
            <table className="min-w-full border border-gray-200 rounded-lg overflow-hidden">
              <thead>
                <tr className="bg-gray-100">
                  <th className="py-4 px-6 text-left">Week</th>
                  <th className="py-4 px-6 text-left">Deep-Dive Workshop</th>
                  <th className="py-4 px-6 text-left">Build-Along Focus</th>
                </tr>
              </thead>
              <tbody className="bg-white">
                {programWeeks.map((week) => (
                  <tr key={week.week} className="border-t border-gray-100 hover:bg-gray-50">
                    <td className="py-4 px-6 font-semibold">{week.week}</td>
                    <td className="py-4 px-6">{week.deepDive}</td>
                    <td className="py-4 px-6">{week.buildAlong}</td>
                  </tr>
                ))}
              </tbody>
            </table>
