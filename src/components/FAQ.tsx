        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-12">
            <Accordion type="single" collapsible className="space-y-4">
              {faqs.map((faq, index) => <AccordionItem key={index} value={`faq-${index}`} className="border border-gray-200 rounded-lg overflow-hidden bg-gray-50">
          ...
          <div className="mt-16 bg-gray-50 p-10 rounded-xl border border-gray-200 shadow-sm">
            <div className="flex items-center mb-5">
              ...
              <span className="text-xl font-medium">Love from the community</span>
            </div>
            
            {/* Replaced testimonial blockquote with Senja widget */}
            <div className="senja-embed" data-id="6dd7efe9-f280-4c2c-99e8-829819340758" data-mode="shadow" data-lazyload="false" style={{
            display: "block",
            width: "100%"
          }}></div>
